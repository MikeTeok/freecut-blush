# Freecut Blush Workspace

This folder is your Freecut Blush project workspace - the app's source of truth
...
`project.json` externally works; Freecut Blush picks up changes on next load.
