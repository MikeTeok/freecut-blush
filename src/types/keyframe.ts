...
/** Deterministic expression source evaluated by Freecut Blush's sandboxed DSL. */
...
/** Incoming keyframes for one property in a bulk upsert (e.g. mask tracking). */
export interface PropertyKeyframeUpsertEntry {
