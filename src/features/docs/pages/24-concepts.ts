  ...
  sections: [
      ...
      blocks: [
        {
          kind: 'list',
          items: [
            'Freecut Blush runs in your browser and stores everything in a **workspace folder** on your disk.',
            'Your original video and audio are **linked**, not copied or uploaded — Freecut Blush points to the files where they already live.',
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: 'Freecut Blush has one primitive for **a timeline inside your project** — a composition. It shows up in two ways depending on how you use it.',
        },
        {
          kind: 'list',
          items: [
        ...
        },
        {
          kind: 'note',
          tone: 'info',
          text: 'A composition can contain other compositions, but never itself — Freecut Blush blocks circular references, so a compound clip can never end up nested inside its own contents.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            'Source media can have a different frame rate than the project, so Freecut Blush converts source frames to project frames when you edit.',
          ],
        },
        {
          kind: 'note',
